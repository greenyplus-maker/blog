  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="prose prose-lg max-w-none space-y-6">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">3. Rights and Obligations of Information Subjects and How to Exercise Them</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">4. Personal Information Items to be Processed</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">5. Destruction of Personal Information</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-4">6. Personal Information Protection Officer</h2>
          <p className="text-gray-700 leading-relaxed">
